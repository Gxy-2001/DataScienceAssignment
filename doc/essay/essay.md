...
在上文中已经确定，多种聚类方法中层次聚类的效果最好，并且当聚类数为3时由图25和图26两个分阶段的聚类效果图
...
对于阶段一典型事件“人传人”，从情感极性强度分析对比图中可以看出，该事件下的大众情感值与当天平均情感值差距较大，且普遍偏低，反映出该事件背景下大众情绪普遍低落且该事件对大众心态具有显著影响，从该事件多维情感分析图和阶段多维情感分析图比较可以看出，该事件背景下大众情感集中维度与阶段情感集中维度具有较显著差异，说明该事件下大众心态具有可分特征。
...
对于阶段二典型事件”武汉封城“，从情感极性强度分析对比图中可以看出，该事件下的大众情感值无明显极性特征，但与当天平均情感值差距仍较大，反映出该事件背景下大众情绪普遍较为平和且该事件对大众心态具有显著影响，从该事件多维情感分析图和阶段多维情感分析图比较可以看出，该事件背景下大众情感集中维度与阶段情感集中维度具有明显差异，说明该事件下大众心态具有可分特征。
